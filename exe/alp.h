...
#define ALP_DMDTYPE_DLPC910REV	 254L	/*  a DLPC910 Update required for controlling this DMD type */
...
#define ALP_DMD_MASK_SELECT		2134L	/* ALP_DEFAULT or ALP_ENABLE, ALP_DMD_MASK_16X8 */
...
#define ALP_X_SHEAR				2337L	/* use AlpProjControlEx and UserStructPtr of type tAlpShearTable */
...
#define ALP_DMD_MASK_WRITE		2339L	/* use AlpProjControlEx and UserStructPtr of type tAlpDmdMask */
...
/* for AlpSeqPutEx(): */
struct tAlpLinePut {
	long TransferMode;	/* common first member of AlpSeqPutEx' UserStructPtr argument */
	long PicOffset;
	long PicLoad;
	long LineOffset;
	long LineLoad;
